...
| OutlineNum | Automatically number sections for RMarkdown headers/outline in RStudio | [OutlineNum](https://github.com/callAgene/OutlineNum) | :white_check_mark: | [BingZhang](https://github.com/callAgene) | [Screenshot](https://github.com/callAgene/OutlineNum/blob/main/vignettes/2.png) | |
